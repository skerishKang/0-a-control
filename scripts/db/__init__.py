...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "get_external_inbox_overview": ("scripts.db_inbox", "get_external_inbox_overview"),
    "get_external_inbox_source_messages": ("scripts.db_inbox", "get_external_inbox_source_messages"),
    "get_agent_statuses": ("scripts.agent_registry", "get_agent_statuses"),
    "get_current_state": ("scripts.db_ops", "get_current_state"),
    ...
    "get_session_view_model": ("scripts.db_session_view", "get_session_view_model"),

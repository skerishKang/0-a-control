...
try:
    from scripts.db_sessions import append_source_record, update_session_summary
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        ct_conn = sqlite3.connect(Path(__file__).resolve().parents[2] / "data" / "control_tower.db")

...
def refresh_current_state(conn: sqlite3.Connection | None = None) -> dict:
    ...
    try:
        ...
        state = {
            ...
            "recommended_next_quest": row_to_dict(current_quest)["next_quest_hint"] if current_quest else None,
            "restart_point": row_to_dict(current_quest)["restart_point"] if current_quest else None,
        ...
        if current_quest:
            ...
            if report and qa_status == "pending":
                ...
                quest_status_summary["waiting_since"] = report.get("reported_at")

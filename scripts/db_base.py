...
SOURCE_RECORDS_FK_VERSION = 3
SOURCE_RECORDS_FK_NAME = "source-records-session-fk"
...
def apply_schema_migrations(conn: sqlite3.Connection) -> None:
    ...
    if not schema_migration_applied(conn, SOURCE_RECORDS_FK_VERSION):
        from scripts.db_fk_migrations import apply_source_records_session_fk

        apply_source_records_session_fk(conn)
        record_schema_migration(
            conn,
            SOURCE_RECORDS_FK_VERSION,
            SOURCE_RECORDS_FK_NAME,
        )
